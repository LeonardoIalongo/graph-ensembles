...
class TestGraph():
    ...
    def test_to_networkx(self):
        ...
        v = [(0, {'node_id': 'ABN', 'group': 'NL'}), 
             (1, {'node_id': 'BNP', 'group': 'FR'}), 
             (2, {'node_id': 'ING', 'group': 'NL'})]
        e = [(0, 1, {'weight': True}),
             (0, 2, {'weight': True}),
             (1, 2, {'weight': True})]
        adj = {0: {1: {'weight': True}, 2: {'weight': True}}, 
    ...
    def test_to_networkx_weights(self):
        ...
        v = [(0, {'node_id': 'ABN', 'group': 'NL'}), 
             (1, {'node_id': 'BNP', 'group': 'FR'}), 
             (2, {'node_id': 'ING', 'group': 'NL'})]
        e = [(0, 1, {'weight': 1e4 + 1.7e5}),
             (0, 2, {'weight': 1e6}),
             (1, 2, {'weight': 3e3})]
        adj = {0: {1: {'weight': 1e4 + 1.7e5}, 2: {'weight': 1e6}}, 
...
class TestDiGraph():
    ...
    def test_init(self):
        g = ge.DiGraph(self.v, self.e, v_id='name',
                       src='creditor', dst='debtor')
    ...
    def test_vertex_group(self):
        ...
        g = ge.DiGraph(v, self.e, v_id='name',
                       src='creditor', dst='debtor', v_group='country')
    ...
    def test_strength_by_group(self):
        g = ge.DiGraph(self.v, self.e, v_id='name', weight='value',
                       src='creditor', dst='debtor', v_group='country')
    ...
    def test_out_degree_by_group(self):
        ...
        d_test = g.out_degree_by_group()

        assert np.all(d_test == d), d_test
        assert np.all(g._out_degree_by_group == d), g._out_degree_by_group
    ...
    def test_in_degree_by_group(self):
        ...
        d_test = g.in_degree_by_group()

        assert np.all(d_test == d), d_test
        assert np.all(g._in_degree_by_group == d), g._in_degree_by_group
    ...
    def test_to_networkx(self):
        ...
        e = [(0, 1, {'weight': True}), 
             ...
             (1, 2, {'weight': True}), 
             (2, 0, {'weight': True})]
        adj = {0: {1: {'weight': True}}, 1: {0: {'weight': True}, 
               2: {'weight': True}}, 2: {0: {'weight': True}}}
    ...
    def test_to_networkx_weights(self):
        ...
        e = [(0, 1, {'weight': 1e4}), 
             ...
             (1, 2, {'weight': 3e3}), 
             (2, 0, {'weight': 1e6})]
        adj = {0: {1: {'weight': 1e4}}, 1: {0: {'weight': 1.7e5}, 
               2: {'weight': 3e3}}, 2: {0: {'weight': 1e6}}}
...
class TestMultiGraph():
    ...
    def test_to_networkx(self):
        ...
        assert np.all(list(gx.edges(data=True)) == e), gx.nodes(data=True)
