...
def vector_fitness_prob_array_block_mult_z(out_strength, in_strength, z, N):
    ...
    with multiple parameters controlling for the density between sectors:
    one for evry couple of sectors.
    """
...
def vector_fitness_link_prob_block_multiple_z(out_strength, in_strength, z):
    ...
    block model, given the parameter z controlling for the density.
    """
