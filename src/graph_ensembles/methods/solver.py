...
def iterative_fit(z0, model, method, nz_out_str, nz_in_str, L, tol=10e-6,
    ...
    d_fun = {
        'CSM-I-fixed-point': lambda x: iterative_stripe_one_z(
            x, nz_out_str, nz_in_str, L),
        'CSM-II-fixed-point': lambda x: iterative_stripe_mult_z(
            x, nz_out_str, nz_in_str, L),
        'CBM-I-fixed-point': lambda x: iterative_block_one_z(
            x, nz_out_str, nz_in_str, L),
        'CBM-II-fixed-point': lambda x: iterative_block_mult_z(
            x, nz_out_str, nz_in_str, L),
        'CSM-I-newton': lambda x: loglikelihood_prime_stripe_one_z(
            x, nz_out_str, nz_in_str, L),
        'CSM-II-newton': lambda x: loglikelihood_prime_stripe_mult_z(
            x, nz_out_str, nz_in_str, L),
        'CBM-I-newton': lambda x: loglikelihood_prime_block_one_z(
            x, nz_out_str, nz_in_str, L),
        'CBM-II-newton': None,
    }
    ...
    d_fun_jac = {
        ...
        'CSM-I-newton': lambda x: loglikelihood_hessian_stripe_one_z(
            x, nz_out_str, nz_in_str),
        'CSM-II-newton': lambda x: loglikelihood_hessian_stripe_mult_z(
            x, nz_out_str, nz_in_str),
        'CBM-I-newton': lambda x: loglikelihood_hessian_block_one_z(
            x, nz_out_str, nz_in_str),
        'CBM-II-newton': None,
    }
