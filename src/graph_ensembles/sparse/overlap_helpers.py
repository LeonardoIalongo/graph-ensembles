class overlap_helpers:
    ...
    def topN_overlap_2_meas(true_meas, est_meas):
        ...
        for l in range(max(true_len, est_len)):
            ...
            topN_overlap_.append(overlap_ij)

        return topN_overlap_
    ...
    # def topN_overlap_pr_out_in(g, self, measures):
    #     """
    ...
    #         self_dict["_topN"+meas] = self.topN_by_rank(self_dict[meas])

    #         # print(f'-self_dict["_topN"+meas]: {self_dict["_topN"+meas]}',)

    #         # calculate the overlal between the topN page-rank on I and the topN of the measure
    #         self_dict["_topN_overlap"+meas] = topN_overlap_g_pr_on_I(g, self_dict["_topN"+meas])

    # def topN_overlap_pr_out_in_degree(self, g = None, internal_nodes = None):
    #     """
    ...
    #     return topN_overlap_pr_out_in(self, g, degree_measures)
    ...
    def topN_overlap_pr_out_in(g, gI_model, measures):
        ...
        for meas in measures:
            ...
            # calculate the overlal between the topN page-rank on I and the topN of the measure
            gI_model_dict["_topN_overlap"+meas] = g.topN_overlap_g_pr_on_I(gI_model_dict["_topN"+meas])
